...
class Register extends REST_Controller
{
    ...
    function post()
    {
		...
		try {
			...
			$datainfo = array('username'=>$LoginName,'password'=>$Password,'typeuser'=>0,'fullname'=>$FullName,'avatar_link'=>$Avatar_link,'phone'=>$Phone,'mail'=>$Email);
			$this->load->model('get_dbuser');
			$this->get_dbuser->insertUser($datainfo);
            $result = array('result'=>array('success'=>true,'info'=>array('Email'=>true,'LoginName'=>true,'Password'=>true,'FullName'=>false,'Phone'=>false),'user_info'=>array('fullname'=>$FullName,'phone'=>$Phone,'email'=>$Email,'username'=>$LoginName,'id'=>1),'message'=>"Register"));
